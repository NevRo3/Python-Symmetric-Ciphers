print("Шифр Цезаря [Было] [Стало] [Обратно]")
s = "Hello world! h e l l o"
...
print("Взлом шифра цезаря [Если взломал, значит ниже будут не иероглифы]")
...
m = "1234567890"
k = "abc"
c = vigenere_encode(k, m)
print(vigenere_decode(k, c))
